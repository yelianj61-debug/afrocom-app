...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        settings.setUserAgentString(settings.getUserAgentString() + " AfrocomApp/1.1");

        // Pont JavaScript → Android pour ouvrir les PDFs de formation
        webView.addJavascriptInterface(new RivoBridge(this), "RivoBridge");
